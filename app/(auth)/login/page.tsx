  ...
  return (
    <LoginShell>
      ...
      <p className="mt-6 text-sm text-ribuzz-muted">
        ¿No tienes cuenta?{" "}
        <Link href="/register" className="font-bold text-ribuzz-pink hover:text-ribuzz-primary">
          Regístrate
        </Link>
      </p>
    </LoginShell>
  ...
  return (
    <main className="ribuzz-shell mx-auto grid min-h-screen max-w-md place-items-center px-6 py-12">
      <section className="glow-card animate-rise w-full rounded-[2rem] p-7">
        <p className="text-xs font-extrabold uppercase tracking-[0.2em] text-ribuzz-pink">
          RiBuzz AI
        </p>
