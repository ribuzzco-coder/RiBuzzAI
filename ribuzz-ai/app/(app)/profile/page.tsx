    ...
    <main className="ribuzz-shell mx-auto max-w-3xl px-6 py-10">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        ...
        <Link
          ...
          className="inline-flex items-center justify-center rounded-full bg-ribuzz-accent px-5 py-3 text-sm font-semibold text-ribuzz-dark transition hover:bg-ribuzz-cyan"
        >
          Nuevo diagnóstico
        </Link>
      </div>
      ...
      <section className="mt-8 space-y-3">
        ...
        {(diagnostics ?? []).length === 0 && (
          <Link
            href="/diagnostic"
            className="block rounded-3xl border-2 border-dashed border-ribuzz-accent/35 bg-white/[0.04] p-8 text-center text-ribuzz-muted transition hover:border-ribuzz-cyan/40 hover:bg-white/[0.08]"
          >
