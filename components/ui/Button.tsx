...
const variantClasses: Record<Variant, string> = {
  primary:
    "border border-ribuzz-accent/28 bg-gradient-to-br from-[#211326] to-[#3A2148] text-white shadow-[0_0_18px_rgba(230,37,255,0.11)] hover:border-ribuzz-accent/45 hover:shadow-[0_0_28px_rgba(230,37,255,0.18)] disabled:opacity-50",
  secondary:
    "border border-white/12 bg-white/[0.055] text-ribuzz-primary shadow-[inset_0_1px_0_rgba(255,255,255,0.06)] hover:border-ribuzz-accent/25 hover:bg-white/[0.08]",
